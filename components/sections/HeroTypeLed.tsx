...
/**
 * Hero variant for businesses without a hero image. Internal to Hero.tsx.
 */
export function HeroTypeLed({ business }: { business: BusinessRow }) {
  ...
  return (
    <header data-section-type="hero_type_led" className="px-5 py-24 border-b border-white/5">
