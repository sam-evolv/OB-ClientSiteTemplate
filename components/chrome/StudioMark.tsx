 ...
 * /media directly rather than via a business_media row. It is the accepted
 * studio lockup on a #080808 ground, which matches this template's --bg, so it
 * sits flush on the footer. Intrinsic size is 1024×544; CSS renders it at
 * height h with width auto to preserve the exact ratio.
 */
